      ...
      <main className="mx-auto px-4 py-8 w-11/12">
        ...
        <section className="mb-10">
          ...
          <p>
            ...
            approach not only ensures that students acquire a deep understanding
            of the material but also cultivates critical thinking,
            problem-solving, and collaboration skills that are invaluable in
