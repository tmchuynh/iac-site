      ...
      <main className="mx-auto px-4 py-8 w-11/12">
        <section className="mb-12">
          ...
          <p className="">
            ...
            shared goal is to inspire, mentor, and equip youth with the skills
            to become tomorrow's creators and innovators. We aim to create an
            environment where imagination knows no bounds, and the innovative
            spirit of the next generation is celebrated. Together, we pave the
            way for a future filled with fresh ideas, groundbreaking inventions,
            and transformative contributions to society.
          </p>
        ...
        <section className="mb-12">
          ...
          <p>
            ...
            comprehension and practical application. We focus on critical
            thinking and problem-solving skills. We embrace inclusivity,
            recognizing the diversity in learners' abilities, backgrounds, and
            ages. Our approach is flexible and personalized, catering to both
            beginners and advanced learners, ensuring value and enrichment for
            all.
          </p>
          <p>
          ...
          <p>
            ...
            learning, stimulating their curiosity and creativity. This program
            is our commitment to providing an environment where every student
            can flourish. Through the harmony of these elements, we aim to
            empower the next generation to shape a promising and transformative
            future.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-2 font-Cute_Rabbit text-lg lg:text-2xl">
            <div className="flex flex-col items-center text-center gap-3 tracking-widest">
              <div className="bg-accent-5 w-fit p-2 rounded-md mx-auto text-background">
                <FaCalendarAlt className="w-8 h-8" />
              </div>
              <p>Schedule a consultation</p>
            </div>
            <div className="flex flex-col items-center text-center gap-3 tracking-widest">
              <div className="bg-accent-2 w-fit p-2 rounded-md mx-auto text-background">
                <FaMoneyBillAlt className="w-8 h-8" />
              </div>
              <p>Discuss pricing and plan options</p>
            </div>
            <div className="flex flex-col items-center text-center gap-3 tracking-widest">
              <div className="bg-accent-3 w-fit p-2 rounded-md mx-auto text-background">
