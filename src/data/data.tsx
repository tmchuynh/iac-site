...
import { GiAmericanFootballHelmet, GiBasketballJersey, GiSoccerBall, GiWhistle } from "react-icons/gi";
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        bio: 'Visionary leader with a passion for education.',
        image: '/images/staff/john_doe.jpg',
        icons: [FaBasketballBall, MdOutlineSportsSoccer, FaVolleyballBall, FaChess,],
        moreInfo: {
