          ...
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <input
                ...
                autoComplete="email"
                className="min-w-0 flex-auto rounded-md/5 px-3.5 py-2 text-base outline outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
              />
              <button
                type="submit"
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              <div className="rounded-md/5 p-2 ring-1 ring-white/10">
                <FaCalendarAlt aria-hidden="true" className="size-6" />
              </div>
            ...
            <div className="flex flex-col items-start">
              <div className="rounded-md/5 p-2 ring-1 ring-white/10">
                <AiOutlineStop aria-hidden="true" className="size-6" />
              </div>
