import { FaCloudRain, FaDatabase, FaUserLock } from "react-icons/fa";

export default function ContentSticky() {
  return (
            ...
            <div className="max-w-xl text-base/7 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8">
                <li className="flex gap-x-3">
                  <FaCloudRain aria-hidden="true" className="mt-1 size-5 flex-none" />
                  <span>
                ...
                <li className="flex gap-x-3">
                  <FaUserLock aria-hidden="true" className="mt-1 size-5 flex-none" />
                  <span>
                ...
                <li className="flex gap-x-3">
                  <FaDatabase aria-hidden="true" className="mt-1 size-5 flex-none" />
                  <span>
