        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
              <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                <p className="mt-2 text-lg font-medium tracking-tight max-lg:text-center">Security</p>
                <p className="mt-2 max-w-lg text-sm/6 max-lg:text-center">
                ...
                <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl shadow-2xl">
                  <div className="flex ring-1 ring-white/5">
                    <div className="-mb-px flex text-sm/6 font-medium">
                      <div className="border-b border-r border-b-white/20 border-r-white/10/5 px-4 py-2">
